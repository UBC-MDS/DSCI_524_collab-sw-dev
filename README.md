...
| 5 | [Continous integration (CI) via GitHub Actions](lectures/05_lecture-continuous-integration-and-github-actions.ipynb) |  | <ul><li>[GitHub Actions docs](https://help.github.com/en/actions)</li></ul> |
