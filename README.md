...
| 3 | [Code reviews, functional testing and advice for testing complex things](lectures/03_lecture-code-review-and-testing.ipynb) |  | <ul><li>[Testing in R](https://r-pkgs.org/tests.html)</li><li>[Testing in Python - reading still TBD]()</li></ul> |
